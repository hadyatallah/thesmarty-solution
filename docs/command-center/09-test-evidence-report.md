...
The local suite contains 112 passing tests, including eleven native Apps Script contract tests. test-evidence.json retains test IDs, exact source hashes, environment, expected/actual outcomes, side effects and timestamps. Local tests use synthetic services; they do not prove live acceptance.
