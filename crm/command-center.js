...
export const commandCenter={
 ...
 statusHtml(){return '<section class="section" id="ccControls"><h3>Approvals, activity and system status</h3><button type="button" data-load-ledger>Refresh action ledger</button><button type="button" data-brief="daily-brief">Prepare daily brief</button><button type="button" data-brief="weekly-review">Prepare weekly review</button><button type="button" data-brief="housekeeping">Check data quality</button><p data-brief-status role="status"></p><div data-ledger role="status">Load the server ledger to review pending approvals, jobs and audit evidence.</div></section><details class="section"><summary>Assistant capabilities and limits</summary><p>CRM reads use your signed-in snapshot. Email history may be partial. Direct sending and publication from this CRM, and automatic WhatsApp inbox access, are unavailable. The existing Outlook connection in ChatGPT/Work is separate and can be used there after exact approval and a business-hours check. A prepared message has not been sent.</p><p>Assistant changes require a server proposal and a separate exact-action approval. If the backend is not connected, changes are blocked.</p></details>';},
