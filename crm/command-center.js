...
export function createManager(snapshot,runtime=null,translatePurpose=null){const crm=new CRMAdapter(snapshot);return new Manager({crm,growth:new GrowthAgent({crm,translatePurpose}),operations:new OperationsAgent({crm,evidence:operationalEvidence(snapshot)}),runtime});}
